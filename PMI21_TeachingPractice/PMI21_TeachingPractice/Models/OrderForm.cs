...
namespace PMI21_TeachingPractice
{
    public partial class OrderForm : Form
    {
        ...
        private void AddToCartButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Product tempProd = new Product(this.dataBase.Products[i]);
                string[] rowElement = { Convert.ToString(tempProd.Name), Convert.ToString(tempProd.Id), Convert.ToString(tempProd.Price),"1", Convert.ToString(tempProd.Price) };
